...
//  					ajax('GET', 'pc/loan/getclassify', params_getclassify).then(res => {
	$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/loan/getclassify',
	        type:'GET',
			xhrFields: {
...
//  					ajax('GET', 'pc/loan/getquerylabels', params_getquerylabels).then(res => {
	$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/loan/getquerylabels',
	        type:'GET',
			xhrFields: {
							withCredentials: true
						},
...
//  					ajax('POST', 'pc/loan/getproducts2', params_getproducts2).then(res => {
		$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/loan/getproducts2',
	        type:'POST',
			xhrFields: {
							withCredentials: true
						},
