...
// 				ajax('GET', 'pc/loan/productlist', params).then(res => {
		$.ajax({
		        url:'http://manage.edgvip.cn:9055/pc/loan/productlist',
		        type:'GET',
				xhrFields: {
							...
							if (list.length > 0) {
								...
								titlebox_uls_html += '<ul class="row">';
									...
									for (var j = 0; j < list.length; j++) {
										...
										titlebox_uls_html += '<a href="loan' + list[j].lpLoanproductId  + '.html">';
...
// 				ajax('GET', 'pc/discuss/newinformations', params002).then(res => {
	$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/discuss/newinformations',
	        type:'GET',
			xhrFields: {
							withCredentials: true
						},
...
// 				ajax('GET', 'pc/discuss/showdiscussList', params003).then(res => {
	$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/discuss/showdiscussList',
	        type:'GET',
			xhrFields: {
							withCredentials: true
						},
...
// 				ajax('GET', 'pc/loan/newproducts', params004).then(res => {
	$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/loan/newproducts',
	        type:'GET',
			xhrFields: {
							withCredentials: true
						},
...
// 				ajax('GET', 'pc/loan/getinterlink', params_getinterlink).then(res => {
		$.ajax({
	        url:'http://manage.edgvip.cn:9055/pc/loan/getinterlink',
	        type:'GET',
			xhrFields: {
							withCredentials: true
						},
